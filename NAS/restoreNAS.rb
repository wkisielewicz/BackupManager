...
PATHS=[{:source =>"'file://#{ENV['HOME']}/NAS/backups/FirebirdUbuntuTest'", :destination =>"/media/kisiel/Data/restore_backups/VirtualBox\ VMs/FirebirdUbuntuTest", :unic_name =>"FirebirdUbuntuTest"},
       {:source =>"'file://#{ENV['HOME']}/NAS/backups/oracle-linux-data'", :destination =>"/media/kisiel/Data/restore_backups/VirtualBox\ VMs/oracle-linux-data", :unic_name =>"oracle-linux-data"},
       {:source =>"'file://#{ENV['HOME']}/NAS/backups/Win8.1'", :destination =>"/media/kisiel/Data/restore_backups/VirtualBox\ VMs/Win8.1", :unic_name =>"Win8.1"},
